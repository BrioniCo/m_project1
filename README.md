...
NOHOME.ie is a parody property-listings site set up to create further awareness of the issue of vacant housing in Ireland. The listings on the site include vacant and derelict properties on the island of Cape Clear with scope to expand nationwide. 
...
![NOHOME.ie][amiresponsive](assets/css/readme-images/amiresponsive.png)![plot](./directory_1/directory_2/.../directory_n/amiresponsive.png)
...
-   -   #### Frequent User Goals
        ...
        1.  As a Frequent User, I want to check to see if there are any newly added sections, listings, information about the campaign or calls to action.
        2.  As a Frequent User, I want to check to see if there are any new blog posts.
        3.  As a Frequent User, I want to be able to contribute my own 'listings' and ideas that may further the campaign.  
        4. As I frequent User, I want to be able to sign up to the Newsletter so that I am emailed any major updates and/or changes to the website or organisation.
...
-   #### Returning Visitor Goals
    ...
    1.  As a Returning Visitor, I want to find the new vacant property listings.
        
        1.  These are clearly shown in divs beneath the call to action section on the home page.
        2.  They will be directed to a page with another hero image and some additional information.
    2.  As a Returning Visitor, I want to find the best way to get in contact with the campaigners with any questions I may have.
        
        1.  The navigation bar clearly highlights the "Contribute" Page.
        2.  Here they can fill out the form on the page or are told that alternatively they can message the organisation on social media.
        3.  The header contains links to the organisations Facebook and Instagram page.
        4.  Whichever link they click, it will be open up in a new tab to ensure the user can easily get back to the website.
        5.  As a Returning Visitor, I want to find the Facebook Group link so that I can join and interact with others in the community.
        
        6.  The Facebook Page can be found at the header of every page and will open a new tab for the user.
       
      
-   #### Frequent User Goals
    
    1.  As a Frequent User, I want to check to see if there are any updates to the campaign or news.
        
        1.  The user would already be comfortable with the website layout and can easily click the banner message.
    2.  As a Frequent User, I want to check to see if there are any new features such as blog posts.
...
![Index/Home wireframe image](assets/readme-images/wireframes_index.png)

![Listings wireframe image](assets/readme-images/wireframes_listings.png)
 ![About wireframe image](assets/readme-images/wireframes_about.png) 
...
There is another link to the *about* page in the The *Record* button on the homepage also takes you to the form on the *about* page. 
![Record button link to About](assets/readme-images/record_button.png)
The *here* in *Click here to view the house you'll never have* takes the user to the Listings page. 
![Alt link to Listings page](assets/readme-images/search-bar-feature.png)
 ...
 * ### Typography
      The fonts chosen were 'Roboto for the headings and 'Lato' for the body text. They both have a fall back of sans-serif set. 
     *  'Roboto' was chosen for the headings as it has a little more imact than the 'Lato' font.  For this reason it made the headings and the logo stand out. 
...
![Colour Palate image](assets/readme-images/rgb_color.png)![Colour Palate image HEX](assets/readme-images/hex.png)
...
![Shadow contrast](assets/readme-images/shadow-for-contrast.png)
...
![Navigation bar image](assets/readme-images/header.png)
[Back to top](<#contents>)
...
![Gallery image](assets/readme-images/search-bar-feature.png)
[Back to top](<#contents>)
  ...
  * ### Listings
    ...
    * The listings boxes copy the format that property listings usually take, except none of these properties are for sale- they are all vacant and/or derelict. Instead, each listing has a bit of a back-story and context. 
    ![Listings page image](assets/readme-images/listings-boxes.png)
    * An iframes of a Google Maps link gives the user added perspective and a sense of place. 

![Google Maps iframe](assets/readme-images/i_frames.png)
[Back to top](<#contents>)
...
![About image with button](assets/readme-images/large_report_button.png)
[Back to top](<#contents>)

  * ### Welcome to NOHOME.ie

    * This information section provides further context to the user .... 
    * They are styled in a box with green border to....
    * This information section will change as the campaign grows and the scope of it spreads nationwide.

![About Section](assets/readme-images/about-welcome.png)
[Back to top](<#contents>)
...
![Footer image](assets/readme-images/#.png)
[Back to top](<#contents>)

* ### Contact Us

    * This brief section includes the email address for applying to join the mailing list as well as some copyright information. 
    As this site is for a campaign and not a business, it is not necessary to include an address and so this has been omitted. 
...
* ### Record a Vacant Home Form
    * This form..... for the user that their details have been sent to Wawas Woods. For this project it validates the form only.
    * 
...
* An interactive map with pinned locations ...
    * This would incorporate an e-commerce platform and an enhanced gallery page.
* An option to host live stream discussions arpund the housing crisis. 
    * Particularly of interest to those whose projects are underway.
* A blog section with written and video updates on the campaign...
